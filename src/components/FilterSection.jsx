...
import FormPrice from '../helpers/FormPrice.jsx'
import {Button} from './Button';

const FilterSection = () => {
  const {
    filters:{text, category,company,color,price,maxPrice,minPrice}, updateFilterValue,clearFilters, all_products,
  } = useFilterContext();
